---
name: teable-api-observability
description: Work with the observability endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting observability API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# observability API Skill

Use this skill to implement or troubleshoot `observability` API flows.
