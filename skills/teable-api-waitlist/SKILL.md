---
name: teable-api-waitlist
description: Work with the waitlist endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting waitlist API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# waitlist API Skill

Use this skill to implement or troubleshoot `waitlist` API flows.
