---
name: teable-api-authority-matrix
description: Work with the authority-matrix endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting authority-matrix API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# authority-matrix API Skill

Use this skill to implement or troubleshoot `authority-matrix` API flows.
