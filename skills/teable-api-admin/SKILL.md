---
name: teable-api-admin
description: Work with the admin endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting admin API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# admin API Skill

Use this skill to implement or troubleshoot `admin` API flows.
