---
name: teable-api-chat
description: Work with the chat endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting chat API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# chat API Skill

Use this skill to implement or troubleshoot `chat` API flows.
