---
name: teable-api-base-node
description: Work with the base node endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting base node API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# base node API Skill

Use this skill to implement or troubleshoot `base node` API flows.
