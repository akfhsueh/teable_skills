---
name: teable-api-attachments
description: Work with the attachments endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting attachments API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# attachments API Skill

Use this skill to implement or troubleshoot `attachments` API flows.
