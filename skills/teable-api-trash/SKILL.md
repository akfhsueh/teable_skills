---
name: teable-api-trash
description: Work with the trash endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting trash API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# trash API Skill

Use this skill to implement or troubleshoot `trash` API flows.
