---
name: teable-api-notification
description: Work with the notification endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting notification API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# notification API Skill

Use this skill to implement or troubleshoot `notification` API flows.
