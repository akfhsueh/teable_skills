---
name: teable-api-mail
description: Work with the mail endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting mail API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# mail API Skill

Use this skill to implement or troubleshoot `mail` API flows.
