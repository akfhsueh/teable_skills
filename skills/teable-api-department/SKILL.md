---
name: teable-api-department
description: Work with the department endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting department API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# department API Skill

Use this skill to implement or troubleshoot `department` API flows.
