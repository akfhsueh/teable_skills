---
name: teable-api-space-manage
description: Work with the space-manage endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting space-manage API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# space-manage API Skill

Use this skill to implement or troubleshoot `space-manage` API flows.
