---
name: teable-api-base
description: Work with the base endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting base API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# base API Skill

Use this skill to implement or troubleshoot `base` API flows.
