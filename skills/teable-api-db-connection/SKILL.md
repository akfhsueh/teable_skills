---
name: teable-api-db-connection
description: Work with the db-connection endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting db-connection API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# db-connection API Skill

Use this skill to implement or troubleshoot `db-connection` API flows.
