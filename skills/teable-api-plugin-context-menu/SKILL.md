---
name: teable-api-plugin-context-menu
description: Work with the plugin-context-menu endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting plugin-context-menu API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# plugin-context-menu API Skill

Use this skill to implement or troubleshoot `plugin-context-menu` API flows.
