---
name: teable-api-pin
description: Work with the pin endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting pin API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# pin API Skill

Use this skill to implement or troubleshoot `pin` API flows.
