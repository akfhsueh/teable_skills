---
name: teable-api-reward
description: Work with the reward endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting reward API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# reward API Skill

Use this skill to implement or troubleshoot `reward` API flows.
