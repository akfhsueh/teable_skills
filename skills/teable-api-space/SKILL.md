---
name: teable-api-space
description: Work with the space endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting space API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# space API Skill

Use this skill to implement or troubleshoot `space` API flows.
