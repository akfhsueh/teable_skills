---
name: teable-api-unsubscribe
description: Work with the unsubscribe endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting unsubscribe API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# unsubscribe API Skill

Use this skill to implement or troubleshoot `unsubscribe` API flows.
