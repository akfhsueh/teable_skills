---
name: teable-api-ai
description: Work with the ai endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting ai API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# ai API Skill

Use this skill to implement or troubleshoot `ai` API flows.
