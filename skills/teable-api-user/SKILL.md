---
name: teable-api-user
description: Work with the user endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting user API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# user API Skill

Use this skill to implement or troubleshoot `user` API flows.
