---
name: teable-api-comment
description: Work with the comment endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting comment API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# comment API Skill

Use this skill to implement or troubleshoot `comment` API flows.
