---
name: teable-api-app
description: Work with the app endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting app API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# app API Skill

Use this skill to implement or troubleshoot `app` API flows.
