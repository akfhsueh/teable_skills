---
name: teable-api-auth
description: Work with the auth endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting auth API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# auth API Skill

Use this skill to implement or troubleshoot `auth` API flows.
