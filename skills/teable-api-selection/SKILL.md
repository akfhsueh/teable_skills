---
name: teable-api-selection
description: Work with the selection endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting selection API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# selection API Skill

Use this skill to implement or troubleshoot `selection` API flows.
