---
name: teable-api-integrity
description: Work with the integrity endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting integrity API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# integrity API Skill

Use this skill to implement or troubleshoot `integrity` API flows.
