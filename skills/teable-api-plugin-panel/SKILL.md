---
name: teable-api-plugin-panel
description: Work with the plugin-panel endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting plugin-panel API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# plugin-panel API Skill

Use this skill to implement or troubleshoot `plugin-panel` API flows.
