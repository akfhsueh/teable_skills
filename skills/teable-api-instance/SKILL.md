---
name: teable-api-instance
description: Work with the instance endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting instance API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# instance API Skill

Use this skill to implement or troubleshoot `instance` API flows.
