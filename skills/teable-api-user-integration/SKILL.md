---
name: teable-api-user-integration
description: Work with the user-integration endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting user-integration API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# user-integration API Skill

Use this skill to implement or troubleshoot `user-integration` API flows.
