---
name: teable-api-credit
description: Work with the credit endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting credit API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# credit API Skill

Use this skill to implement or troubleshoot `credit` API flows.
