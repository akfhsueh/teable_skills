---
name: teable-api-integration
description: Work with the integration endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting integration API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# integration API Skill

Use this skill to implement or troubleshoot `integration` API flows.
