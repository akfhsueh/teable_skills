---
name: teable-api-invitation
description: Work with the invitation endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting invitation API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# invitation API Skill

Use this skill to implement or troubleshoot `invitation` API flows.
