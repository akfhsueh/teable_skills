---
name: teable-api-table
description: Work with the table endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting table API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# table API Skill

Use this skill to implement or troubleshoot `table` API flows.
