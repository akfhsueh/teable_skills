---
name: teable-api-automation
description: Work with the automation endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting automation API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# automation API Skill

Use this skill to implement or troubleshoot `automation` API flows.
