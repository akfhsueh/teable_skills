---
name: teable-api-organization
description: Work with the organization endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting organization API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# organization API Skill

Use this skill to implement or troubleshoot `organization` API flows.
