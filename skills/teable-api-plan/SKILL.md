---
name: teable-api-plan
description: Work with the plan endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting plan API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# plan API Skill

Use this skill to implement or troubleshoot `plan` API flows.
