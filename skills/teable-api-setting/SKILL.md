---
name: teable-api-setting
description: Work with the setting endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting setting API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# setting API Skill

Use this skill to implement or troubleshoot `setting` API flows.
