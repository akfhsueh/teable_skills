---
name: teable-api-plugin
description: Work with the plugin endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting plugin API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# plugin API Skill

Use this skill to implement or troubleshoot `plugin` API flows.
