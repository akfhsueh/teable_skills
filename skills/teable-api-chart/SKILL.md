---
name: teable-api-chart
description: Work with the chart endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting chart API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# chart API Skill

Use this skill to implement or troubleshoot `chart` API flows.
