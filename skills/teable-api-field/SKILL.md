---
name: teable-api-field
description: Work with the field endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting field API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# field API Skill

Use this skill to implement or troubleshoot `field` API flows.
