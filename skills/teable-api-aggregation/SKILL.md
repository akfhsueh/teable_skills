---
name: teable-api-aggregation
description: Work with the aggregation endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting aggregation API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# aggregation API Skill

Use this skill to implement or troubleshoot `aggregation` API flows.
