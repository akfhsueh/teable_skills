---
name: teable-api-share
description: Work with the share endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting share API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# share API Skill

Use this skill to implement or troubleshoot `share` API flows.
