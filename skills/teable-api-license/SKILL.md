---
name: teable-api-license
description: Work with the license endpoints from the Teable App OpenAPI spec. Use when implementing, debugging, or documenting license API calls, request payloads, response shapes, and auth behavior in Teable integrations.
---

# license API Skill

Use this skill to implement or troubleshoot `license` API flows.
